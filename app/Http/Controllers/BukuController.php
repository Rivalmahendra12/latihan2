...
public function index(Request $request)
    {
        ...
        return view('buku_beranda', $data);
    }

    public function tambah()
    {
        $data['model'] = new \App\Buku();
    ...
    public function simpan(Request $request)
    {
        ...
        return redirect('admin/buku/beranda')->with('pesan', 'data sudah disimpan');
    }

    public function edit($id)
    {
        $data['model'] = \App\Buku::findOrFail($id);
